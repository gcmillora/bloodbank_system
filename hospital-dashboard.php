...
<body>
  ...
  <div class="overview">
    ...
    <div class="util-bar">
      ...
      <span class="put-margins"><button onclick="showResult(document.getElementById('tfield').value,'N')">Search</button></span>
      <span class="put-margins"><button onclick='sortReq("user.User_Name","no");'>Reset</button></span>
